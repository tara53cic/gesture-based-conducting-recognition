...
- recording.py      - Collects gesture data using webcam <br>
- train.py          - Preprocesses data & trains ML model <br>
- live.py           - Runs real-time conducting detection <br>
- dataset/          - Stored training data <br>
- songs/            - Audio files for playback <br>
- conductor_ai.h5   - Saved trained model <br>
